...
<div data-type="media" data-alt="A shows the bacteriophage sitting on the outside of the cell; the phage DNA is inside the phage. The host cell shows host DNA. B shows phage DNA entering host. C shows phage DNA replicates as well as protein particles. D shows new bacteriophages forming. E shows new phage particles exiting host bacterial cell.">
![A shows the bacteriophage sitting on the outside of the cell; the phage DNA is inside the phage. The host cell shows host DNA. B shows phage DNA entering host. C shows phage DNA replicates as well as protein particles. D shows new bacteriophages forming. E shows new phage particles exiting host bacterial cell.](../resources/OSC_Microbio_06_02_stages_img.jpg)
</div>
</div>
</div>
