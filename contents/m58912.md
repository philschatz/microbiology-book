...
<th data-valign="top" data-align="center">Available Vaccine(s)<sup data-type="footnote-number" id="footnote-ref2"><a data-type="footnote-link" href="#footnote2">2</a></sup></th>
</tr>
</thead><tbody>
<tr valign="top">
...
* {: data-type="footnote-ref" #footnote1} [1](#footnote-ref1){: data-type="footnote-ref-link"} <span data-type="footnote-ref-content">J. Kluytmans et al. “Nasal Carriage of *Staphylococcus aureus*\: Epidemiology, Underlying Mechanisms, and Associated Risks.” *Clinical Microbiology Reviews* 10 no. 3 (1997):505–520.</span>
* {: data-type="footnote-ref" #footnote2} [2](#footnote-ref2){: data-type="footnote-ref-link"} <span data-type="footnote-ref-content">Full names of vaccines listed in table: *Haemophilus influenzae* type B (Hib); Diphtheria, tetanus, and acellular pertussis (DtaP); tetanus, diphtheria, and acellular pertussis (Tdap); diphtheria and tetanus (DT); tetanus and diphtheria (Td); diphtheria, pertussis, and tetanus (DTP); Bacillus Calmette-Guérin; Measles, mumps, rubella (MMR)</span>
