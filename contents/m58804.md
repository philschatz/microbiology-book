...
<div data-type="media" data-alt="a) a long strand with walls dividing it into rectanges. B) A long square with no walls between the nuclei.">
![a) a long strand with walls dividing it into rectanges. B) A long square with no walls between the nuclei.](../resources/OSC_Microbio_05_03_Hyphae_img.jpg)
</div>
</div>
</div>
