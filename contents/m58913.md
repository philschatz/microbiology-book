...
Pneumonia is a general term for infections of the lungs that lead to inflammation and accumulation of fluids and white blood cells in the alveoli. Pneumonia can be caused by bacteria, viruses, fungi, and other organisms, although the vast majority of pneumonias are bacterial in origin. Bacterial pneumonia is a prevalent, potentially serious infection; it caused more 50,000 deaths in the United States in 2014.[<sup>3</sup>](#footnote3){: data-type="footnote-number" name="footnote-ref3"} As the alveoli fill with fluids and white blood cells (consolidation), air exchange becomes impaired and patients experience respiratory distress ([\[link\]](#OSC_Microbio_22_02_Pneumonia)). In addition, pneumonia can lead to **pleurisy**{: data-type="term" .no-emphasis}, an infection of the pleural membrane surrounding the lungs, which can make breathing very painful. Although many different bacteria can cause pneumonia under the right circumstances, three bacterial species cause most clinical cases: ***Streptococcus pneumoniae***{: data-type="term" .no-emphasis}, ***H*. *influenzae***{: data-type="term" .no-emphasis}, and ***Mycoplasma pneumoniae***{: data-type="term" .no-emphasis}. In addition to these, we will also examine some of the less common causes of pneumonia.
...
In infants, coughing can be forceful enough to cause fractures to the ribs, and prolonged infections can lead to death. The CDC reported 20 pertussis-related deaths in 2012,[<sup>9</sup>](#footnote9){: data-type="footnote-number" name="footnote-ref9"} but that number had declined to five by 2015.[<sup>10</sup>](#footnote10){: data-type="footnote-number" name="footnote-ref10"}
...
Once diagnosed, Legionnaire disease can be effectively treated with fluoroquinolone and macrolide antibiotics. However, the disease is sometimes fatal; about 10% of patients die of complications.[<sup>11</sup>](#footnote11){: data-type="footnote-number" name="footnote-ref11"} There is currently no vaccine available.
...
1.  [1](#footnote-ref1){: data-type="footnote-ref" name="footnote1"} WL Lean et al. “Rapid Diagnostic Tests for Group A Streptococcal Pharyngitis: A Meta-Analysis.” *Pediatrics* 134, no. 4 (2014):771–781.
2.  [2](#footnote-ref2){: data-type="footnote-ref" name="footnote2"} G. Worrall. “Acute Otitis Media.” *Canadian Family Physician* 53 no. 12 (2007):2147–2148.
3.  [3](#footnote-ref3){: data-type="footnote-ref" name="footnote3"} KD Kochanek et al. “Deaths: Final Data for 2014.” *National Vital Statistics Reports* 65 no 4 (2016).
4.  [4](#footnote-ref4){: data-type="footnote-ref" name="footnote4"} SM Koenig et al. “Ventilator-Associated Pneumonia: Diagnosis, Treatment, and Prevention.” *Clinical Microbiology Reviews* 19 no. 4 (2006):637–657.
5.  [5](#footnote-ref5){: data-type="footnote-ref" name="footnote5"} R. Sordé et al. “Management of Refractory *Pseudomonas aeruginosa* Infection in Cystic Fibrosis.” *Infection and Drug Resistance* 4 (2011):31–41.
6.  [6](#footnote-ref6){: data-type="footnote-ref" name="footnote6"} Centers for Disease Control and Prevention. “Tuberculosis (TB). Data and Statistics.” http://www.cdc.gov/tb/statistics/default.htm
7.  [7](#footnote-ref7){: data-type="footnote-ref" name="footnote7"} D. Saini et al. “Ultra-Low Dose of *Mycobacterium tuberculosis* Aerosol Creates Partial Infection in Mice.” *Tuberculosis* 92 no. 2 (2012):160–165.
8.  [8](#footnote-ref8){: data-type="footnote-ref" name="footnote8"} G. Kaplan et al. “*Mycobacterium tuberculosis* Growth at the Cavity Surface: A Microenvironment with Failed Immunity.” *Infection and Immunity* 71 no.12 (2003):7099–7108.
9.  [9](#footnote-ref9){: data-type="footnote-ref" name="footnote9"} Centers for Disease Control and Prevention. “2012 Final Pertussis Surveillance Report.” 2015. http://www.cdc.gov/pertussis/downloads/pertuss-surv-report-2012.pdf. Accessed July 6, 2016.
10. [10](#footnote-ref10){: data-type="footnote-ref" name="footnote10"} Centers for Disease Control and Prevention. “2015 Provisional Pertussis Surveillance Report.” 2016. http://www.cdc.gov/pertussis/downloads/pertuss-surv-report-2015-provisional.pdf. Accessed July 6, 2016.
11. [11](#footnote-ref11){: data-type="footnote-ref" name="footnote11"} Centers for Disease Control and Prevention. “*Legionella* (Legionnaires’ Disease and Pontiac Fever: Diagnosis, Treatment, and Complications).” http://www.cdc.gov/legionella/about/diagnosis.html. Accessed Sept 14, 2016.
12. [12](#footnote-ref12){: data-type="footnote-ref" name="footnote12"} WD Tigertt et al. “Airborne Q Fever.” *Bacteriological Reviews* 25 no. 3 (1961):285–293.
13. [13](#footnote-ref13){: data-type="footnote-ref" name="footnote13"} Centers for Disease Control and Prevention. “Q fever. Symptoms, Diagnosis, and Treatment.” 2013. http://www.cdc.gov/qfever/symptoms/index.html. Accessed July 6, 2016.
